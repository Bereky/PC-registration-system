...
const SideNav = ({route}) => {
    ...
    return(
        <div className={`${sidebarState? 'w-24' : 'w-64'} h-3/4 flex flex-col space-y-2 justify-between`}> 
            <div className="w-full h-5/6 flex justify-start items-center flex-col mt-3 "> 
                
                <div className='w-full h-14 flex justify-center items-center'>
                    <div className={`h-12 rounded-lg ${ route === 'dashboard' && 'bg-slate-200'} ${sidebarState? 'w-3/6' : 'w-5/6'} flex justify-center items-center flex-row hover:bg-slate-200`}>
                ...
                <div className='w-full h-14 flex justify-center items-center'>
                    <div className={`h-12 rounded-lg ${ route === 'scanner' && 'bg-slate-200'} ${sidebarState? 'w-3/6' : 'w-5/6'} flex justify-center items-center flex-row hover:bg-slate-200`}>
                ...
                <div className='w-full h-14 flex justify-center items-center'>
                    <div className={`h-12 rounded-lg ${ route === 'registration' && 'bg-slate-200'} ${sidebarState? 'w-3/6' : 'w-5/6'} flex justify-center items-center flex-row hover:bg-slate-200`}>
                ...
                <div className='w-full h-14 flex justify-center items-center'>
                    <div className={`h-12 rounded-lg ${ route === 'update' && 'bg-slate-200'} ${sidebarState? 'w-3/6' : 'w-5/6'} flex justify-center items-center flex-row hover:bg-slate-200`}>
                ...
                <div className='w-full h-14 flex justify-center items-center'>
                    <div className={`h-12 rounded-lg ${ route === 'setting' && 'bg-slate-200'}  ${sidebarState? 'w-3/6' : 'w-5/6'} flex justify-center items-center flex-row hover:bg-slate-200`}>
                        <Link to="/" className='w-full flex justify-center items-center'>
                            <div className="w-12 h-full flex justify-center items-center">
                                <ReportIcon />
                            </div>
                            <div className={`w-2/4 flex justify-start items-center ${sidebarState? 'hidden' : 'flex'}`}>
                                <h1 className="w-3/4 text-lg font-bold">Report</h1>
                            </div>
                        </Link>
                    </div>
                </div>
